...
<html>
<head>
<title>Admin - Shipped Orders | Electronics Store</title>
<meta charset="utf-8">
	...
	<div class="container" style="margin-top: 30px; margin-bottom: 60px;">
		...
		<div style="margin-bottom: 25px;">
			<h2 style="font-size: 26px; margin: 0; display: flex; align-items: center; gap: 10px;">
				<i class="fas fa-check-circle" style="color: var(--success);"></i> Shipped Orders History
			</h2>
			<p style="color: var(--text-muted); font-size: 14px; margin-top: 4px;">Archive of all dispatched customer orders and fulfilled transactions</p>
		</div>
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center">
								<span style="background: var(--success-bg); color: #047857; border: 1px solid #6EE7B7; font-size: 11px; font-weight: 700; padding: 4px 10px; border-radius: var(--radius-full);">
						...
						%>
						<tr>
							<td colspan="7" class="text-center" style="padding: 35px; color: var(--text-muted); font-size: 14px;">No shipped orders recorded yet</td>
						</tr>
						<%
						}
						%>
