...
<html>
<head>
<title>Update Product Search | Admin Portal</title>
<meta charset="utf-8">
		...
		<div class="row" style="width: 100%;">
			<form action="updateProduct.jsp" method="post"
				...
				<div class="text-center" style="margin-bottom: 25px;">
					...
					<h3 style="font-size: 22px; margin-bottom: 6px;">Find Product to Edit</h3>
					<p style="color: var(--text-muted); font-size: 13px;">Enter Product ID to open the update editor</p>
